...
% RIMUOVERE L'AMBIENTE DEFINIZIONE CHE MI SEMBRA APPESANTISCA
...
\begin{definizione}[\emph{\acl{BH}} (terza versione)]
...
%\subsection{Interazione tra issuer e hunter}
...
% INGLOBARE QUESTA SEZIONE CON LA PRECENDENTE
...
%\subsection{Adozione e vantaggi}
...
% INGLOBARE CON LA SEZIONE PRECEDENTE
...
% RICONTROLLA PRIMA DELLA CONSEGNA
